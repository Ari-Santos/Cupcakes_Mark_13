...
def product_details(product_id):
    ...
    products = {
        1: {"name": "Delícia das Trevas de Chocolate", "price": 5.50, "description": "Chocolate intenso com um toque sombrio"},
        2: {"name": "Doce Sangrento de Morango", "price": 6.50, "description": "Um cupcake macabro coberto de geleia vermelha"},
        3: {"name": "Monstro Cremoso de Baunilha", "price": 5.00, "description": "FaUm recheio assustador que vai te surpreender!"}
    }
